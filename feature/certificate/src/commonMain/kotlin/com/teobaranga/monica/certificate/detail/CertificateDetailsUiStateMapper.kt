        ...
        add(
            CertificateDetailsUiState.Section(
                ...
                items = listOf(
                    ...
                    CertificateDetailsUiState.Section.Item(
                        title = "Public Value",
                        value = publicKey.iosEncoded.toHexString(hexFormat),
                    ),
                ),
            )
        )
            ...
            CertificateDetailsUiState.Section(
                ...
                items = buildList {
                    add(
                        CertificateDetailsUiState.Section.Item(
                            title = "Serial Number",
                            value = tbsCertificate.serialNumber.toHexString(hexFormat),
                        )
                    )
                    add(
                        CertificateDetailsUiState.Section.Item(
                            title = "Signature Algorithm",
                            value = when (val algorithm = tbsCertificate.signatureAlgorithm.algorithm) {
                                is SignatureAlgorithm.ECDSA -> {
                                    buildString {
                                        append("ECDSA")
                                        if (algorithm.digest != null) {
        ...
        add(
            CertificateDetailsUiState.Section(
                ...
                items = listOf(
                    CertificateDetailsUiState.Section.Item(
                        title = "SHA-256",
                        value = commonCertificate.sha256,
                    ),
                    CertificateDetailsUiState.Section.Item(
                        title = "SHA-1",
                        value = commonCertificate.sha1,
                    ),
                ),
            )
        )
            ...
            add(
                CertificateDetailsUiState.Section(
                    ...
                    items = listOf(
                        CertificateDetailsUiState.Section.Item(
                            title = "Key ID",
                            value = subjectKeyId.toHexString(hexFormat),
                        )
                    ),
                )
            )
            ...
            add(
                CertificateDetailsUiState.Section(
                    ...
                    items = listOf(
                        CertificateDetailsUiState.Section.Item(
                            title = "Key ID",
                            value = authorityKeyId.toHexString(hexFormat),
                        )
                    ),
                )
            )
